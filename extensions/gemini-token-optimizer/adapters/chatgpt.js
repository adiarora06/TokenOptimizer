(() => {
  ...
  function insertPrompt(prompt) {
    ...
    const box = findPromptBox();
    if (!box) return { ok: false, message: "Open ChatGPT and click inside the message box first." };
    ...
    if (box.tagName === "TEXTAREA") {
      ...
      return { ok: true, message: "Inserted the prepared prompt into ChatGPT." };
    }
